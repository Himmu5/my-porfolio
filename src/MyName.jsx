...
export default function MyName() {
  return (
    <div className='flex flex-col justify-center  text-black shadow-xl bg-white pt-40 pl-4 pr-4 pb-40 m-5   sm:flex-row sm:gap-5 sm:p-40 sm:m-20 rounded-xl '>
        ...
        <h1 className='text-blue-700 text-center mt-10 text-5xl font-bold '>Hy, my name is Himanshu Chauhan </h1>
        <p className='text-lg mt-3 text-center'> I am a React developer and I have created many responsive Web UI using React . </p>
